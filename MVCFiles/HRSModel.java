...
public class HRSModel {
     ...
     *  @param cOut The check-out date.
     * 
     *  @return 1 if removal success; -1 if failed
     */
    public int removeReservation(String hotel, String fName, String lName, 
    String room, int cIn, int cOut) 
    {
        try {
            Hotel currHotel = findHotel(hotel);
            return currHotel.removeReservation(fName, lName, cIn, cOut, 
                        room.substring(0, 3));
        } catch (Exception e) {
            return -1;
        }
    ...
    /**
     * Gets the recent hotel made
     * 
     * @return The recent/newest hotel
     */
    ...
    /**
     * Gets the hotel name on the specified index
     * 
    ...
    /**
     * Finds the hotel with the provided name
     * 
     * @param name The name of the hotel to find
     * @return The Hotel object found, null if not found
     */
    ...
    /**
     * Gets the number of reservation in a hotel
     * 
     * @param name The hotel to find
     * @return The number of reservations, -1 if an exception is thrown
     */
